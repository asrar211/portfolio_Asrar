    ...
    <div className="py-4 bg-neutral-950 border border-neutral-900 rounded-xl p-3">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2">
          <span className="p-1 bg-neutral-800 border border-neutral-700/30 rounded-md">
            {icon}
          </span>
          <h1 className="text-[16.5px] text-neutral-200 font-light">{title}</h1>
        </div>
        <p className="text-[13px] mr-6 font-light text-neutral-400">
          {description}
        </p>
      </div>

      {/* Schedule a Call Button with Link */}
      <a
        href="https://wa.me/917889789033?text=Hi%20Asrar!%20I%20want%20to%20schedule%20a%20call%20regarding%20your%20services."
        target="_blank"
        rel="noopener noreferrer"
        className="block bg-neutral-800/60 rounded-xl text-[14px] text-neutral-400 cursor-pointer font-light px-2 py-3 flex justify-center w-full items-center gap-2 mt-3 hover:bg-neutral-800/80 transition-all duration-300"
      >
        <IconPhoneCalling color="yellow" size={19} />
        Schedule a Call
      </a>
    </div>
  );
